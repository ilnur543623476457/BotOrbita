                        ...
                        fs.readFile('prBybitCoin.txt', 'utf8', (err, dataByb) => {
                            ...
                            if (coinName1 === coinName2) {
                                ...
                                if (formula_bin_byb_exit > spred) {
                                    // console.log(`${coinName2} Покупка ${pocupcaOne}  Продажа ${prodajaOne}`)
                                    console.log(`бинанс -> байбит ${coinName1} ${formula_bin_byb_exit} Покупка ${pocupcaOne}  Продажа ${prodajaOne}`);
                                ...
                                if (formula_bin_byb_exit < spred) {
                                    ...
                                    // console.log('no limit spred bin_byb');
                                }

                                // формула процент (байбит / бинанс)
                                var pocupcaTwo = prbybcn.split(',')[2]
                                var prodajaTwo = prbincn.split(',')[4]
                                ...
                                if (formula_byb_bin_exit > spred) {
                                    // console.log(`${coinName2} Покупка ${pocupcaTwo}  Продажа ${prodajaTwo}`)
                                    console.log(`байбит -> бинанс ${coinName2} ${formula_byb_bin_exit} Покупка ${pocupcaTwo}  Продажа ${prodajaTwo}`);
                                ...
                                if (formula_byb_bin_exit < spred) {
                                    ...
                                    // console.log('no limit spred byb_bin');
                                }
                            }
                        })
                    })
